...
Application state is described with the superposition of two main container types - [Record](04_Record/00_Overview.md) and [Collection](05_Collection/00_Overview.md) or records. The state has observable changes and is serializable by default.
