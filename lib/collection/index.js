...
import { define, definitions, EventMap, eventsApi, Mixable, mixinRules, tools } from '../object-plus';
...
var Collection = (function (_super) {
    ...
    Collection.prototype._log = function (level, topic, text, value) {
        _super.prototype._log.call(this, level, topic, this.model.prototype.getClassName() + "." + this.getClassName() + ": " + text, {
            Argument: value,
