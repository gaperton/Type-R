...
import { define, definitions, EventMap, eventsApi, Mixable, mixinRules, tools, log } from '../object-plus';
...
var trigger2 = eventsApi.trigger2, on = eventsApi.on, off = eventsApi.off, begin = transactionApi.begin, commit = transactionApi.commit, markAsDirty = transactionApi.markAsDirty, omit = tools.omit, assign = tools.assign, defaults = tools.defaults, assignToClassProto = tools.assignToClassProto;
var _count = 0;
...
var Collection = (function (_super) {
    ...
    Collection.prototype._log = function (level, topic, text, value) {
