...
var MixinsState = (function () {
        ...
        for (var _i = 0, mixins_1 = mixins; _i < mixins_1.length; _i++) {
            ...
            if (Array.isArray(mixin)) {
                ...
                if (typeof mixin === 'function') {
                    ...
                    var sourceMixins = this.Class.mixins;
                    if (sourceMixins) {
    ...
    MixinsState.prototype.mergeObject = function (dest, source, unshift) {
        ...
        forEachOwnProp(source, function (name) {
            var sourceProp = Object.getOwnPropertyDescriptor(source, name), definitionRule = _this.definitionRules[name];
            if (definitionRule) {
                assignProperty(_this.definitions, name, sourceProp, definitionRule, unshift);
            }
            else {
