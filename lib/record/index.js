...
import { createSharedTypeSpec, ChainableAttributeSpec, AggregatedType, SharedType } from './attributes';
...
Record.onDefine = function (definition, BaseClass) {
    ...
    var _a = compile(this.attributes = getAttributes(definition), baseProto._attributes), properties = _a.properties, dynamicMixin = __rest(_a, ["properties"]);
