...
import { tools, eventsApi, definitions, mixinRules, define } from '../object-plus';
import { transactionApi, Transactional } from '../transactions';
import { AnyType, AggregatedType, setAttribute, begin, markAsDirty } from './attributes';
var trigger3 = eventsApi.trigger3, assign = tools.assign, isEmpty = tools.isEmpty, log = tools.log, free = transactionApi.free, aquire = transactionApi.aquire, commit = transactionApi.commit, _begin = transactionApi.begin, _markAsDirty = transactionApi.markAsDirty;
var _cidCounter = 0;
