...
import { define, definitions, isProduction, mixinRules, tools } from '../object-plus';
import { Transactional } from '../transactions';
import { AggregatedType, AnyType, setAttribute, shouldBeAnObject, unknownAttrsWarning, UpdateRecordMixin } from './attributes';
...
var Record = (function (_super) {
    ...
    Record.prototype._log = function (level, topic, text, props) {
        _super.prototype._log.call(this, level, topic, text, tslib_1.__assign({}, props, { 'Record': this, 'Attributes definition:': this._attributes }));
    };
