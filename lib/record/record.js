...
import { define, definitions, isProduction, log, mixinRules, tools } from '../object-plus';
...
var Record = (function (_super) {
    ...
    Record.prototype._log = function (level, topic, text, props) {
        log(level, topic, text, tslib_1.__assign({}, props, { 'Record': this, 'Attributes definition:': this._attributes }));
    };
