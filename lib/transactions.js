...
var Transactional = (function () {
    ...
    Transactional.fromJSON = function (json) {
        var obj = this.create(json, { parse: true, logger: throwingLogger });
        obj.isValid() || obj.eachValidationError(function (error, key, obj) {
