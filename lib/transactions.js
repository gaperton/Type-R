...
import { define, definitions, eventsApi, Messenger, mixinRules, mixins, log } from './object-plus';
...
var Transactional = (function () {
    ...
    Transactional.prototype._log = function (level, topic, text, value) {
        for (var p = this; p; p = this._owner) {
