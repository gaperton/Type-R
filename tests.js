...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Mixins', function () {
	    it('merges objects to the prototype, if they are not defined', function () {});
	
	    it('works on a plain class', function () {});
	...
	describe('Class#define', function () {
	    it('adds members to the prototype', function () {
	        var C = (function (_Class) {
	            ...
	            function C() {
	                ...
	                _get(Object.getPrototypeOf(_C.prototype), 'constructor', this).apply(this, arguments);
	            }
	        ...
	        (0, _chai.expect)(C.prototype.a).equal('a');
	    });
	
	    it('defines properties passed in "properties" spec', function () {
	        var C = (function (_Class2) {
	            _inherits(C, _Class2);
	
	            function C() {
	                _classCallCheck(this, _C2);
	
	                _get(Object.getPrototypeOf(_C2.prototype), 'constructor', this).apply(this, arguments);
	            }
	        ...
	        var c = new C();
	        (0, _chai.expect)(c.p).to.equal('Hey');
	    });
	
	    it('clear up "create" factory method on inheritance', function () {
	        var A = (function (_Class3) {
	            _inherits(A, _Class3);
	
	            function A() {
	                _classCallCheck(this, _A);
	
	                _get(Object.getPrototypeOf(_A.prototype), 'constructor', this).apply(this, arguments);
	            }
	        ...
	        var B = (function (_A2) {
	            ...
	            function B() {
	                ...
	                _get(Object.getPrototypeOf(_B.prototype), 'constructor', this).apply(this, arguments);
	            }
	
	            var _B = B;
	            B = (0, _tools.define)(B) || B;
	            return B;
	        })(A);
	
	        (0, _chai.expect)(B.create()).to.be.instanceOf(B);
	    });
	
	    it('merges mixin rules on inheritance', function () {
	        var A = (function (_Class4) {
	            _inherits(A, _Class4);
	
	            function A() {
	                _classCallCheck(this, _A3);
	
	                _get(Object.getPrototypeOf(_A3.prototype), 'constructor', this).apply(this, arguments);
	            }
	        ...
	        (0, _chai.expect)(A._mixinRules.a).to.eql('merge');
	        ...
	        var B = (function (_A4) {
	            ...
	            function B() {
	                ...
	                _get(Object.getPrototypeOf(_B2.prototype), 'constructor', this).apply(this, arguments);
	            }
	        ...
	        (0, _chai.expect)(B._mixinRules.a).to.eql('merge');
	        (0, _chai.expect)(B._mixinRules.b).to.eql('merge');
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcRecord = __webpack_require__(2);
	
	var _chai = __webpack_require__(7);
	
	describe('Record', function () {
	    it("can be instantiated", function () {
	        new _srcRecord.Record();
	    });
	
	    describe('Subclass', function () {
	        it("attaches properties to prototype", function () {
	            var M = (function (_Record) {
	                _inherits(M, _Record);
	
	                function M() {
	                    _classCallCheck(this, _M);
	
	                    _get(Object.getPrototypeOf(_M.prototype), 'constructor', this).apply(this, arguments);
	                }
	            ...
	            (0, _chai.expect)(M.prototype.a).to.eql('a');
	        });
	    });
	
	    describe("Attribute spec", function () {
	        describe('...as constructors', function () {
	            var M = (function (_Record2) {
	                _inherits(M, _Record2);
	
	                function M() {
	                    _classCallCheck(this, _M2);
	
	                    _get(Object.getPrototypeOf(_M2.prototype), 'constructor', this).apply(this, arguments);
	                }
	            ...
	            it("invokes constructor to create defaults", function () {
	                var m = new M();
	                (0, _chai.expect)(m.s).to.equal('');
	                (0, _chai.expect)(m.n).to.equal(0);
	                (0, _chai.expect)(m.b).to.equal(false);
	                (0, _chai.expect)(m.o).to.eql({});
	                (0, _chai.expect)(m.a).to.eql([]);
	                (0, _chai.expect)(m.d).to.be['instanceof'](Date);
	            });
	            ...
	            it("convert values to defined type in 'new'", function () {
	                ...
	                (0, _chai.expect)(m.s).to.equal('55');
	                (0, _chai.expect)(m.n).to.equal(1);
	                (0, _chai.expect)(m.b).to.equal(true);
	                (0, _chai.expect)(m.o).to.eql({});
	                (0, _chai.expect)(m.a).to.eql([]);
	                (0, _chai.expect)(m.d).to.be['instanceof'](Date);
	            });
	        ...
	        describe('...as default values', function () {
	            var M = (function (_Record3) {
	                _inherits(M, _Record3);
	
	                function M() {
	                    _classCallCheck(this, _M3);
	
	                    _get(Object.getPrototypeOf(_M3.prototype), 'constructor', this).apply(this, arguments);
	                }
	            ...
	            it("accepts values as type spec", function () {
	                var m = new M();
	                (0, _chai.expect)(m.s).to.equal('b');
	                (0, _chai.expect)(m.n).to.equal(1);
	                (0, _chai.expect)(m.b).to.equal(true);
	
	                (0, _chai.expect)(m.o).to.not.equal({});
	                (0, _chai.expect)(m.o).to.eql({});
	
	                (0, _chai.expect)(m.a).to.not.equal([]);
	                (0, _chai.expect)(m.a).to.eql([]);
	            ...
	            it("infers types from values", function () {
	                var m = new M();
	                var _attributes = m._attributes;
	
	                (0, _chai.expect)(_attributes.s.type).to.equal(String);
	                (0, _chai.expect)(_attributes.n.type).to.equal(Number);
	                (0, _chai.expect)(_attributes.b.type).to.equal(Boolean);
	                (0, _chai.expect)(_attributes.o.type).to.equal(Object);
	                (0, _chai.expect)(_attributes.a.type).to.equal(Array);
	                (0, _chai.expect)(_attributes.d.type).to.equal(Date);
	            });
	        });
	        describe('...as constructors with values', function () {
	            it("converts default values to defined types", function () {
	                var M = (function (_Record4) {
	                    _inherits(M, _Record4);
	
	                    function M() {
	                        _classCallCheck(this, _M4);
	
	                        _get(Object.getPrototypeOf(_M4.prototype), 'constructor', this).apply(this, arguments);
	                    }
	            ...
	            it("accepts null as default value", function () {
	                var M = (function (_Record5) {
	                    _inherits(M, _Record5);
	
	                    function M() {
	                        _classCallCheck(this, _M5);
	
	                        _get(Object.getPrototypeOf(_M5.prototype), 'constructor', this).apply(this, arguments);
	                    }
	                ...
	                (0, _chai.expect)(m.s).to.equal(null);
	                (0, _chai.expect)(m.n).to.equal(null);
	                (0, _chai.expect)(m.b).to.equal(null);
	                (0, _chai.expect)(m.o).to.eql(null);
	                (0, _chai.expect)(m.a).to.eql(null);
	                (0, _chai.expect)(m.d).to.eql(null);
	            });
	        });
	    });
	    ...
	    describe("Record's collection", function () {
	        it("is defined in the base Record", function () {
	            (0, _chai.expect)(_srcRecord.Record.Collection).to.be.a('function');
	            (0, _chai.expect)(_srcRecord.Record.Collection.prototype.Record).to.eql(_srcRecord.Record);
	        });
	
	        it("is created on Record's extension", function () {
	            var M = (function (_Record6) {
	                _inherits(M, _Record6);
	
	                function M() {
	                    _classCallCheck(this, _M6);
	
	                    _get(Object.getPrototypeOf(_M6.prototype), 'constructor', this).apply(this, arguments);
	                }
	
	                var _M6 = M;
	                M = (0, _tools.define)(M) || M;
	                return M;
	            })(_srcRecord.Record);
	
	            var prototype = M.Collection.prototype;
	
	            (0, _chai.expect)(prototype).to.be['instanceof'](_srcRecord.Record.Collection);
	            (0, _chai.expect)(prototype.Record).to.eql(M);
	        });
	
	        it("takes properties from .collection", function () {
	            var M = (function (_Record7) {
	                _inherits(M, _Record7);
	
	                function M() {
	                    _classCallCheck(this, _M7);
	
	                    _get(Object.getPrototypeOf(_M7.prototype), 'constructor', this).apply(this, arguments);
	                }
	            ...
	            (0, _chai.expect)(M.Collection.prototype.a).to.eql('a');
	        });
	
	        it("can be defined separately", function () {
	            var C = (function (_Collection) {
	                _inherits(C, _Collection);
	            ...
	            var M = (function (_Record8) {
	                _inherits(M, _Record8);
	
	                function M() {
	                    _classCallCheck(this, _M8);
	
	                    _get(Object.getPrototypeOf(_M8.prototype), 'constructor', this).apply(this, arguments);
	                }
	            ...
	            (0, _chai.expect)(M.Collection).to.eql(C);
	            var prototype = M.Collection.prototype;
	
	            (0, _chai.expect)(prototype).to.be['instanceof'](_srcRecord.Record.Collection);
	            (0, _chai.expect)(prototype.a).to.eql('a');
	            (0, _chai.expect)(prototype.Record).to.eql(M);
	        });
	    });
	
	    describe('Record pre-definition', function () {
	        var M1 = (function (_Record9) {
	            _inherits(M1, _Record9);
	
	            function M1() {
	                _classCallCheck(this, _M1);
	
	                _get(Object.getPrototypeOf(_M1.prototype), 'constructor', this).apply(this, arguments);
	            }
	
	            var _M1 = M1;
	            M1 = (0, _tools.define)(M1) || M1;
	            return M1;
	        })(_srcRecord.Record);
	
	        var M2 = (function (_Record10) {
	            _inherits(M2, _Record10);
	
	            function M2() {
	                _classCallCheck(this, M2);
	
	                _get(Object.getPrototypeOf(M2.prototype), 'constructor', this).apply(this, arguments);
	            }
	        ...
	        it('predefine collection types', function () {
	            (0, _chai.expect)(M1.Collection).to.be.func;
	            (0, _chai.expect)(M2.Collection).to.be.func;
	        });
	        ...
	        it('support forward declaration', function () {
	            var M = (function (_Record11) {
	                _inherits(M, _Record11);
	
	                function M() {
	                    _classCallCheck(this, _M9);
	
	                    _get(Object.getPrototypeOf(_M9.prototype), 'constructor', this).apply(this, arguments);
	                }
	            ...
	            (0, _chai.expect)(M.Collection).to.be.a('function');
	            (0, _chai.expect)(M.Collection.prototype.Record).to.eql(M);
